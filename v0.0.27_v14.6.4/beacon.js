        ...
        !(function () {
          ...
          !(function () {
              ...
              if (f && m && m.token) {
                ...
                document.addEventListener('visibilitychange', function () {
                  if ('hidden' === document.visibilityState) {
                    if (L && A()) {
                      var t = e();
                      ((null == S ? void 0 : S.url) == t && (null == S ? void 0 : S.triggered)) ||
                        P(),
                        O(t);
                    }
                    !E && S && ((E = !0), R());
                ...
                var L = m && (void 0 === m.spa || !0 === m.spa),
                  ...
                  P = function (r) {
                    var a = function (e, t) {
                        (c.resources = e),
                          ...
                          m &&
                            (1 === m.r && (c.resources = []),
                            (0, o.sendObjectBeacon)('', c, function () {}, !1, C),
                            void 0 !== m.forward &&
                              void 0 !== m.forward.url &&
                              (0, o.sendObjectBeacon)('', c, function () {}, !1, m.forward.url));
                      },
                      c = (function (r) {
                        var o,
                          a,
                        ...
                        if (
                          ...
                          var h =
                              null !== (o = f.getEntriesByType('resource')) && void 0 !== o
                                ? o
                                : [],
                            T = 0,
                            w = 0;
                        ...
                        return (
                          JSON.stringify(g).length >= 64e3 && (g.resources = []),
                  ...
                  B = function () {
                    ...
                    t ? t.then(P) : P(),
                      (S = { id: v, url: e(), ts: new Date().getTime(), triggered: !0 });
                  };
            ...
            function _(e) {
              ...
              switch (
                ('INP' !== e.name && (b[e.name.toLowerCase()] = { value: e.value, path: u }),
                e.name)
              ) {
                case 'CLS':
                  (c = e.attribution) &&
                    ...
                    (b.cls.currentRect =
                      null === (t = c.largestShiftSource) || void 0 === t ? void 0 : t.currentRect),
                    (b.cls.previousRect =
                ...
                case 'FID':
                  (c = e.attribution) &&
                    b.fid &&
                    ((b.fid.element = c.eventTarget), (b.fid.name = c.eventType));
                  break;
                case 'LCP':
                  (c = e.attribution) &&
                    b.lcp &&
                    ...
                    (b.lcp.it =
                      null === (i = c.lcpResourceEntry) || void 0 === i ? void 0 : i.initiatorType),
                    (b.lcp.fp =
                      null ===
                ...
                case 'INP':
                  (null == b.inp || Number(b.inp.value) < Number(e.value)) &&
                    ...
                    (c = e.attribution) &&
                      b.inp &&
                      ((b.inp.element = c.eventTarget), (b.inp.name = c.eventType)));
              }
            }
            function x() {
              return f.timeOrigin;
          ...
          var t,
                      ...
                      e.forEach(function (e) {
                        'first-contentful-paint' === e.name &&
                          ...
                          e.startTime < i.firstHiddenTime &&
                            ((o.value = Math.max(e.startTime - v(), 0)), o.entries.push(e), n(!0)));
                      });
                    });
                  a &&
            ...
            j = function () {
              'interactionCount' in performance ||
                o ||
                (o = m('event', D, { type: 'event', buffered: !0, durationThreshold: 0 }));
            },
            q = 0,
            H = function () {
              return V() - q;
